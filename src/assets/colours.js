...
export const ICON_BROWN = '#938262'; //Construction
export const ICON_PURPLE = '#bd85ef'; //Camera
export const ICON_BLUE = '#8d96ec'; //Nook Miles
export const ICON_BLUE_LIGHT = '#95d1da'; //Call Islander
export const ICON_AQUA = '#88e0bb'; //Map
export const ICON_GREEN = '#8dce8d'; //Passport
export const ICON_CHARTREUSE = '#d0dc4b'; //Chat
export const ICON_YELLOW = '#eddd6e'; //Shopping
export const ICON_YELLOW_DARK = '#facb62'; //Critterpedia
export const ICON_ORANGE_LIGHT = '#f8c07f'; //Best Friends
